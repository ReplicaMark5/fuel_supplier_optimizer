...
class FuelOptimizationPrecomputation:
    ...
    def __init__(self, config_path: str = str(Path(__file__).resolve().parents[1] / "data/config/optimization_config.json"), db_path: str = str(Path(__file__).resolve().parents[1] / "data/databases/fuel_data.db")):
